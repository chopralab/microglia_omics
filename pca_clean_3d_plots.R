...
make_pca_plot <- function(tp, design_mat, gr, contrasts,
  ...
  prcomp_data %>%
    pca3d(group = groups, labels.col = labels, biplot.vars = 3, show.ellipses = TRUE, ellipse.ci = 0.75,
          show.plane=FALSE, legend="bottomright") 
    # snapshotPCA3d(file = "figures/primary_pca_cl_combined_01_and_24h_3D.png")
    # snapshotPCA3d(file = "figures/primary_pca_cl_combined_01_and_24h_3D.pdf")
    # ggtitle(title) +
...
# svglite::svglite("figures/primary_pca_cl_combined_01_and_24h_3D.svg")
# cl_01_24h %>%
#   make_pca_plot(design_01_24h, gr_01_24h, contrasts_01_24h, "Cell Lipids at 01 Hr and 24 Hrs Together")
# dev.off()

# pdf("figures/primary_pca_cl_combined_01_and_24h_3D.pdf") 
# cl_01_24h %>%
#   make_pca_plot(design_01_24h, gr_01_24h, contrasts_01_24h, "Cell Lipids at 01 Hr and 24 Hrs Together")
# dev.off()
